...
module.exports = class extends Component {
    render() {
        ...
        const { url_for, cdn, font, iconcdn, is_post } = helper;
        const {
            url,
            head = {},
            article,
        ...
        return <head>
            ...
            <link rel="stylesheet" href={url_for('/css/all.css')} />
            {/* <link rel="stylesheet" href={iconcdn()} /> */}
            {hlTheme ? <link rel="stylesheet" href={url_for('/css/' + hlTheme + '.css')} /> : null}
